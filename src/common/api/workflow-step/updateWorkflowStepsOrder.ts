import UpdateWorkflowStepsOrderGQL from 'src/common/graphql/workflow-step/UpdateWorkflowStepsOrder';
import { ItemOrder } from 'src/common/types/ItemOrder';
import { isNewID, rejectParentRequired } from '../../utils/api-utils';
import client from '../client';

export const updateWorkflowStepsOrder = (
  orders: ItemOrder[],
  stepId: string
  ...
  isNewID(stepId)
    ...
    : client
        .mutate({
          mutation: UpdateWorkflowStepsOrderGQL,
